"""
Evaluator for circle packing example (n=32) with improved timeout handling
"""
...
def evaluate(program_path):
    ...
    TARGET_VALUE = 2.937  # AlphaEvolve result for n=32
    ...
    try:
        ...
        if not shape_valid:
            print(
                f"Invalid shapes: centers={centers.shape}, radii={radii.shape}, expected (32, 2) and (32,)"
            )
            valid = False
